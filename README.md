...
| 📝 [notes-app](https://github.com/devSHUKLApriyank/notes-app) | A modern, responsive notes app with LocalStorage persistence | React, Tailwind CSS |
| 🔗 [url-shortener-backend](https://github.com/devSHUKLApriyank/url-shortener-backend) | Backend service for shortening URLs | JavaScript |
